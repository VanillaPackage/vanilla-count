...
class PortugueseLocaleTest extends TestCase
{
    ...
    public function dataSpellCurrency()
    {
        return [
            ...
            [ [ 'currency' => 'dollar' ], 0, 'zero dólar' ],
            [ [ 'currency' => 'dollar' ], 1, 'um dólar' ],
            [ [ 'currency' => 'dollar' ], 2, 'dois dólares' ],
            [ [ 'currency' => 'dollar' ], 1000, 'mil dólares' ],
            [ [ 'currency' => 'dollar' ], 1001, 'mil e um dólares' ],
            [ [ 'currency' => 'dollar' ], 1002, 'mil e dois dólares' ],
            [ [ 'currency' => 'dollar' ], 1000000, 'um milhão de dólares' ],
            [ [ 'currency' => 'dollar' ], 2000000, 'dois milhões de dólares' ],
            [ [ 'currency' => 'dollar' ], 1001001, 'um milhão, mil e um dólares' ],
            [ [ 'currency' => 'dollar' ], 1001001, 'um milhão, mil e um dólares' ],
            [ [ 'currency' => 'dollar' ], 1002000000, 'um bilhão e dois milhões de dólares' ],

            [ [ 'currency' => 'dollar' ], 1000, 'mil dólares' ],
            [ [ 'currency' => 'dollar' ], 1001, 'mil e um dólares' ],
            [ [ 'currency' => 'dollar' ], 1010, 'mil e dez dólares' ],
            [ [ 'currency' => 'dollar' ], 1011, 'mil e onze dólares' ],
            [ [ 'currency' => 'dollar' ], 1021, 'mil e vinte e um dólares' ],
            [ [ 'currency' => 'dollar' ], 1100, 'mil e cem dólares' ],
            [ [ 'currency' => 'dollar' ], 1101, 'mil, cento e um dólares' ],
            [ [ 'currency' => 'dollar' ], 1111, 'mil, cento e onze dólares' ],

            [ [ 'currency' => 'dollar' ], 2000, 'dois mil dólares' ],
            [ [ 'currency' => 'dollar' ], 3000, 'três mil dólares' ],
            [ [ 'currency' => 'dollar' ], 4000, 'quatro mil dólares' ],
            [ [ 'currency' => 'dollar' ], 5000, 'cinco mil dólares' ],
            [ [ 'currency' => 'dollar' ], 6000, 'seis mil dólares' ],
            [ [ 'currency' => 'dollar' ], 7000, 'sete mil dólares' ],
            [ [ 'currency' => 'dollar' ], 8000, 'oito mil dólares' ],
            [ [ 'currency' => 'dollar' ], 9000, 'nove mil dólares' ],

            [ [ 'currency' => 'dollar' ], 0.01, 'um centavo' ],
            [ [ 'currency' => 'dollar' ], 0.15, 'quinze centavos' ],

            [ [ 'currency' => 'dollar' ], 0.00, 'zero dólar' ],
            [ [ 'currency' => 'dollar' ], 1.00, 'um dólar' ],
            [ [ 'currency' => 'dollar' ], 2.00, 'dois dólares' ],
            [ [ 'currency' => 'dollar' ], 2.01, 'dois dólares e um centavo' ],
            [ [ 'currency' => 'dollar' ], 2.50, 'dois dólares e cinquenta centavos' ],

            [ [ 'currency' => 'dollar' ], 1000.01, 'mil dólares e um centavo' ],
            [ [ 'currency' => 'dollar' ], 1101.01, 'mil, cento e um dólares e um centavo' ],
            [ [ 'currency' => 'dollar' ], 1000000.01, 'um milhão de dólares e um centavo' ],
            [ [ 'currency' => 'dollar' ], 1001001.01, 'um milhão, mil e um dólares e um centavo' ],

            [ [ 'currency' => 'dollar' ], 2000.02, 'dois mil dólares e dois centavos' ],
            [ [ 'currency' => 'dollar' ], 2000000.02, 'dois milhões de dólares e dois centavos' ],
            [ [ 'currency' => 'dollar' ], 2002002.02, 'dois milhões, dois mil e dois dólares e dois centavos' ],

            [ [ 'currency' => 'dollar', 'currencyLocale' => null ], 1, 'um dollar' ],
            [ [ 'currency' => 'dollar', 'currencyLocale' => null ], 2, 'dois dollars' ],
            [ [ 'currency' => 'dollar', 'currencyLocale' => null ], 1000, 'mil dollars' ],
        ];
    }
}
