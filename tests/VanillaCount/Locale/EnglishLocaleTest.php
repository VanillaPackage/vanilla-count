...
class EnglishLocaleTest extends TestCase
{
    ...
    public function dataSpellCurrency()
    {
        return [
            ...
            [ [ 'defaultCurrency' => 'real' ], 0, 'zero real' ],
            [ [ 'defaultCurrency' => 'real' ], 1, 'one real' ],
            [ [ 'defaultCurrency' => 'real' ], 2, 'two reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1000, 'one thousand reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1001, 'one thousand and one reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1002, 'one thousand and two reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1000000, 'one million reais' ],
            [ [ 'defaultCurrency' => 'real' ], 2000000, 'two million reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1001001, 'one million, one thousand and one reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1001001, 'one million, one thousand and one reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1002000000, 'one billion and two million reais' ],

            [ [ 'defaultCurrency' => 'real' ], 1000, 'one thousand reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1001, 'one thousand and one reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1010, 'one thousand and ten reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1011, 'one thousand and eleven reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1021, 'one thousand and twenty-one reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1100, 'one thousand and one hundred reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1101, 'one thousand, one hundred and one reais' ],
            [ [ 'defaultCurrency' => 'real' ], 1111, 'one thousand, one hundred and eleven reais' ],

            [ [ 'defaultCurrency' => 'real' ], 2000, 'two thousand reais' ],
            [ [ 'defaultCurrency' => 'real' ], 3000, 'three thousand reais' ],
            [ [ 'defaultCurrency' => 'real' ], 4000, 'four thousand reais' ],
            [ [ 'defaultCurrency' => 'real' ], 5000, 'five thousand reais' ],
            [ [ 'defaultCurrency' => 'real' ], 6000, 'six thousand reais' ],
            [ [ 'defaultCurrency' => 'real' ], 7000, 'seven thousand reais' ],
            [ [ 'defaultCurrency' => 'real' ], 8000, 'eight thousand reais' ],
            [ [ 'defaultCurrency' => 'real' ], 9000, 'nine thousand reais' ],

            [ [ 'defaultCurrency' => 'real' ], 0.01, 'one cent' ],
            [ [ 'defaultCurrency' => 'real' ], 0.15, 'fifteen cents' ],

            [ [ 'defaultCurrency' => 'real' ], 0.00, 'zero real' ],
            [ [ 'defaultCurrency' => 'real' ], 1.00, 'one real' ],
            [ [ 'defaultCurrency' => 'real' ], 2.00, 'two reais' ],
            [ [ 'defaultCurrency' => 'real' ], 2.01, 'two reais and one cent' ],
            [ [ 'defaultCurrency' => 'real' ], 2.50, 'two reais and fifty cents' ],

            [ [ 'defaultCurrency' => 'real' ], 1000.01, 'one thousand reais and one cent' ],
            [ [ 'defaultCurrency' => 'real' ], 1101.01, 'one thousand, one hundred and one reais and one cent' ],
            [ [ 'defaultCurrency' => 'real' ], 1000000.01, 'one million reais and one cent' ],
            [ [ 'defaultCurrency' => 'real' ], 1001001.01, 'one million, one thousand and one reais and one cent' ],

            [ [ 'defaultCurrency' => 'real' ], 2000.02, 'two thousand reais and two cents' ],
            [ [ 'defaultCurrency' => 'real' ], 2000000.02, 'two million reais and two cents' ],
            [ [ 'defaultCurrency' => 'real' ], 2002002.02, 'two million, two thousand and two reais and two cents' ],

            [ [ 'defaultCurrency' => 'real', 'defaultLocale' => 'pt' ], 2000.02, 'two thousand reais and two centavos' ],
            [ [ 'defaultCurrency' => 'real', 'defaultLocale' => 'pt' ], 2000000.02, 'two million reais and two centavos' ],
            [
                [ 'defaultCurrency' => 'real', 'defaultLocale' => 'pt' ],
                2002002.02,
